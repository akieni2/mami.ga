...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['slug' => 'municipal.finance.mission.submit', 'name' => 'Soumettre une mission financière', 'module' => 'municipality'],
            ['slug' => 'municipal.finance.mission.controller_review', 'name' => 'Revoir une mission (contrôleur)', 'module' => 'municipality'],
            ['slug' => 'municipal.finance.mission.daf_review', 'name' => 'Revoir une mission (DAF)', 'module' => 'municipality'],
            ['slug' => 'municipal.finance.approval.view_queue', 'name' => 'Consulter la file de validation', 'module' => 'municipality'],
            ...
            ['slug' => 'municipal.finance.remittance.control', 'name' => 'Contrôler les reversements trésor', 'module' => 'municipality'],
            ['slug' => 'municipal.finance.remittance.daf_validate', 'name' => 'Valider DAF les reversements trésor', 'module' => 'municipality'],
            ['slug' => 'municipal.finance.remittance.receveur_validate', 'name' => 'Valider receveur les reversements trésor', 'module' => 'municipality'],
            ['slug' => 'municipal.finance.remittance.deposit', 'name' => 'Enregistrer le dépôt trésor', 'module' => 'municipality'],
            ['slug' => 'municipal.finance.remittance.confirm', 'name' => 'Confirmer le reversement trésor', 'module' => 'municipality'],
            ['slug' => 'municipal.finance.remittance.reject', 'name' => 'Rejeter un reversement trésor', 'module' => 'municipality'],
        ...
        $rolePermissions = [
            ...
            MamiRole::Daf->value => [
                ...
                'municipal.finance.remittance.daf_validate',
                'municipal.finance.remittance.reject',
                'municipal.fiscal.view',
                'municipal.tax.view',
            ...
            MamiRole::ControleurFinancier->value => [
                ...
                'municipal.finance.journal.view',
                'municipal.finance.remittance.view',
                'municipal.finance.remittance.control',
                'municipal.fiscal.view',
            ],
            MamiRole::ReceveurMunicipal->value => [
                ...
                'municipal.finance.remittance.view',
                'municipal.finance.remittance.manage',
                'municipal.finance.remittance.receveur_validate',
                'municipal.finance.remittance.deposit',
                'municipal.finance.remittance.confirm',
                'municipal.finance.remittance.reject',
                'municipal.finance.journal.view',
                'municipal.fiscal.view',
                'municipal.cash_session.open',
